  ...
  tools { 
   ...
   stages{
	...
	stage('Push') {
            steps {
                script{
                    docker.withRegistry('https://410129828206.dkr.ecr.us-west-2.amazonaws.com', 'ecr:us-west-2:aws-credentials', 'ecr:us-west-2:aws-credentials') {
                    app.push("latest")
                    }
                }
            }
